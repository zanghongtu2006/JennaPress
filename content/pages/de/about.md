...
blocks:
  - type: feature-grid
    ...
    items:
      - title: Zu viele kleine Websites werden zu versehentlichen Apps
        description: Viele Website-Projekte beginnen als einfache Publishing-Aufgabe und driften dann in Dashboards, Runtime-APIs und fragile Deployment-Geschichten ab.
      - title: Kleine Teams brauchen klare Grenzen
        description: Ein statisches Projekt bleibt wartbarer, wenn Autoren, Template-Entwickler und Framework-Regeln jeweils einen klaren Arbeitsbereich haben.
      - title: Mehrsprachigkeit sollte entworfen und nicht nur angeflickt werden
